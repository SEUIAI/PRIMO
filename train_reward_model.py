...
parser.add_argument("--model", default='bert-base-cased', type=str, help="backbone of encoder.")
parser.add_argument("--train_path", default="dataset/reward_datasets/train.tsv", type=str, help="The path of train set.")
parser.add_argument("--dev_path", default="dataset/reward_datasets/dev.tsv", type=str, help="The path of dev set.")
parser.add_argument("--save_dir", default="models/RM_checkpoints", type=str, required=False, help="The output directory where the model predictions and checkpoints will be written.")
parser.add_argument("--max_seq_len", default=128, type=int,help="The maximum total input sequence length after tokenization. Sequences longer "
...
parser.add_argument("--img_log_name", default='BERT Reward Model', type=str, help="Logging image file name.")
parser.add_argument('--device', default="cuda:2", help="Select which device to train model, defaults to gpu.")
...
def train():
    ...
    eval_dataloader = DataLoader(eval_dataset, shuffle=True, collate_fn=default_data_collator, batch_size=args.batch_size)
